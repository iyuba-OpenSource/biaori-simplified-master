package com.iyuba.biaori.simplified.ui.login;
...
import com.iyuba.biaori.simplified.presenter.login.WxLoginPresenter;
...
public class WxLoginActivity extends AppCompatActivity implements WxLoginContract.WxLoginView {
    ...
    private String wxKey = "wx2818d9926ec9fa73";
    ...
    private void initOperation() {
        ...
        String url_Agreement = Constant.URL_PROTOCOLUSE;
        ...
        String url_PrivacyPolicy = Constant.URL_PROTOCOLPRI;
    ...
    public void getWxAppletToken(WxLoginBean wxLoginBean) {
        ...
        IWXAPI api = WXAPIFactory.createWXAPI(this, wxKey);
        ...
        req.userName = "gh_7ba8558f7613"; // 填小程序原始id
        req.path = "/packageA/pages/getphone/getphone?token=" + wxLoginBean.getToken() + "&appid=" + Constant.APPID;
    ...
    public void getUidByToken(WxLoginBean wxLoginBean) {
        ...
        wxLoginPresenter.getMoreInfo("android", 20001, wxLoginBean.getUid(), wxLoginBean.getUid(), Constant.APPID, sign);
    }
    ...
    public void getUserInfo(MoreInfoBean moreInfoBean, String uid) {
        ...
        UserBean.UserinfoDTO userBean = new UserBean.UserinfoDTO();
        userBean.setUid(Integer.parseInt(uid));
        userBean.setUsername(moreInfoBean.getUsername());
        userBean.setVipStatus(moreInfoBean.getVipStatus());
        userBean.setImgSrc(moreInfoBean.getMiddleUrl());
