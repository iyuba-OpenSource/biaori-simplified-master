...
public class CPWordAdapter extends BaseQuickAdapter<JpWord, BaseViewHolder> {

    public CPWordAdapter(int layoutResId, @Nullable List<JpWord> data) {
    ...
    protected void convert(@NonNull BaseViewHolder helper, JpWord item) {
        ...
        //中文
        helper.setText(R.id.cpword_tv_wordch, item.getWordCh());
